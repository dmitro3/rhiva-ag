CREATE TABLE "pnls" (
	...
	"config" jsonb,
	"pnlUsd" double precision DEFAULT 0 NOT NULL,
	...
	"claimedBaseFee" double precision DEFAULT 0 NOT NULL,
	"claimedQuoteFee" double precision DEFAULT 0 NOT NULL,
	"claimedBaseFeeUsd" double precision DEFAULT 0 NOT NULL,
	"claimedQuoteFeeUsd" double precision DEFAULT 0 NOT NULL,
	"claimedRewardsUsd" double precision DEFAULT 0 NOT NULL,
	...
	"unclaimedRewardsFee" double precision[] DEFAULT '{}' NOT NULL,
	"unclaimedRewardsFeeUsd" double precision[] DEFAULT '{}' NOT NULL,
	"createdAt" timestamp with time zone DEFAULT now() NOT NULL,
	"updatedAt" timestamp with time zone DEFAULT now() NOT NULL,
	"state" text DEFAULT 'opened' NOT NULL,
	"amountUsd" double precision GENERATED ALWAYS AS (COALESCE("pnls"."baseAmountUsd"::decimal) + COALESCE("pnls"."quoteAmountUsd"::decimal, 0)) STORED NOT NULL,
	"unclaimedFeeUsd" double precision GENERATED ALWAYS AS (COALESCE("pnls"."unclaimedBaseFeeUsd"::decimal) + COALESCE("pnls"."unclaimedQuoteFeeUsd"::decimal, 0)) STORED NOT NULL,
	"claimedFeeUsd" double precision GENERATED ALWAYS AS (COALESCE("pnls"."claimedBaseFee"::decimal) + COALESCE("pnls"."claimedQuoteFee"::decimal, 0)) STORED NOT NULL,
